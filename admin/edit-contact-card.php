...
<head>
    ...
    <title>Edit Kontak — Dapoer Funraise</title>
    ...
    <div class="main-wrapper">
        <div class="form-box">
            ...
            <div class="form-body">
                ...
                <form id="editForm" method="POST">
                    ...
                    <div class="input-pair">
                        <div class="input-group">
                            ...
                            <input 
                                ...
                                id="icon_class" 
                                name="icon_class"
                                value="<?= htmlspecialchars($card['icon_class']) ?>"
                    ...
                    <div class="input-pair">
                        ...
                        <div class="input-group">
                            ...
                            <input 
                                ...
                                id="href" 
                                name="href"
                                value="<?= htmlspecialchars($card['href']) ?>"
                    ...
                    <!-- Baris 3: Urutan | Checkbox (Lurus & Rapi) -->
                    <div class="input-pair">
                        <div class="input-group">
        ...
        <div class="preview-box">
            ...
            <div class="preview-body">
                <!-- Langsung tampilkan elemen, tidak dalam .preview-card -->
                ...
                <div class="preview-href" id="previewHref">
                    <?= htmlspecialchars($card['href']) ?: '—' ?>
                </div>
                <div class="preview-meta">
                    <span class="preview-order" id="previewOrder">Urutan: <?= $card['sort_order'] ?></span>
                    <span class="preview-status <?= $card['is_active'] ? 'status-active' : 'status-inactive' ?>" id="previewStatus">
